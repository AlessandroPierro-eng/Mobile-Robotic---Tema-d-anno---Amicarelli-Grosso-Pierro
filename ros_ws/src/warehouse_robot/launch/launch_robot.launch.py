...
def generate_launch_description():
    ...
    declare_robot_name = DeclareLaunchArgument('robot_name', default_value='robot1', description='Robot namespace')
    declare_x = DeclareLaunchArgument('x', default_value='0.0', description='Gazebo X coordinate')
    declare_y = DeclareLaunchArgument('y', default_value='0.0', description='Gazebo Y coordinate')
    declare_yaw = DeclareLaunchArgument('yaw', default_value='0.0', description='Gazebo Yaw orientation')

    # ==========================================
    # 2. ROBOT STATE AND JOINT PUBLISHERS
    # ==========================================
